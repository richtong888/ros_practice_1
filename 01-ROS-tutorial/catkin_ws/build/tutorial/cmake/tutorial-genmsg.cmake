...
get_filename_component(_filename "/home/richtong/HCC-Lab-2020/01-ROS-tutorial/catkin_ws/src/tutorial/srv/MulTwoInts.srv" NAME_WE)
add_custom_target(_tutorial_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "tutorial" "/home/richtong/HCC-Lab-2020/01-ROS-tutorial/catkin_ws/src/tutorial/srv/MulTwoInts.srv" ""
)

get_filename_component(_filename "/home/richtong/HCC-Lab-2020/01-ROS-tutorial/catkin_ws/src/tutorial/srv/my_srv.srv" NAME_WE)
add_custom_target(_tutorial_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "tutorial" "/home/richtong/HCC-Lab-2020/01-ROS-tutorial/catkin_ws/src/tutorial/srv/my_srv.srv" ""
)
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/tutorial)
  install(CODE "execute_process(COMMAND \"/usr/bin/python2\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/tutorial\")")
  # install generated code
  install(
