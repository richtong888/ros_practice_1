...
class MulTwoIntsResponse {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('multi')) {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    // Serialize message field [multi]
    bufferOffset = _serializer.int32(obj.multi, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    // Deserialize message field [multi]
    data.multi = _deserializer.int32(buffer, bufferOffset);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    if (msg.multi !== undefined) {
      resolved.multi = msg.multi;
    }
    else {
      resolved.multi = 0
    }
...
module.exports = {
  ...
  md5sum() { return '22e1fb5e47d069b2b327ca34488a755a'; },
